...
```bash
$ git clone https://github.com/NewYorkCoinNYC/Electrum-Server_Rust
$ cd electrs
$ cargo build --release
```
...
If you are using `-rpcuser=USER` and `-rpcpassword=PASSWORD` of `bitcoind` for authentication, please use `cookie="USER:PASSWORD"` option in one of the [config files](https://github.com/NewYorkCoinNYC/Electrum-Server_Rust/blob/master/doc/usage.md#configuration-files-and-priorities).
...
See below for [extra configuration suggestions](https://github.com/NewYorkCoinNYC/Electrum-Server_Rust/blob/master/doc/usage.md#extra-configuration-suggestions) that you might want to consider.

## Electrum client

If you happen to use the Electrum client from [the **experimental** Debian repository](https://github.com/NewYorkCoinNYC/Electrum-Server_Rust/blob/master/doc/usage.md#cnative-os-packages), it's pre-configured out-of-the-box already. Read below otherwise.
...
If you use [the **experimental** Debian repository](https://github.com/NewYorkCoinNYC/Electrum-Server_Rust/blob/master/doc/usage.md#cnative-os-packages), it is cleaner to install `tor-hs-patch-config` using `apt` and then placing the configuration into a file inside `/etc/tor/hidden-services.d`.
...
If you use [the **experimental** Debian repository](https://github.com/NewYorkCoinNYC/Electrum-Server_Rust/blob/master/doc/usage.md#cnative-os-packages), you should skip this section, as the appropriate systemd unit file is installed automatically.
...
[contrib/addr.py](https://github.com/NewYorkCoinNYC/Electrum-Server_Rust/blob/master/contrib/addr.py) for getting an address balance:
